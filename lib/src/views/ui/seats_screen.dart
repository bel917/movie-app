...
class _SeatsScreenState extends State<SeatsScreen> {
  ...
  void payM() async {
    if (index == -1) {
      ...
      insertOrder(prefs.getString('name'), widget.movie.title, seatsString,
          widget.movie.cinemaName, time, sub, widget.movie.price, code);
  ...
  void insertOrder(String id, String movieId, String seat, String ciname,
      String time, String order, String price, String code) async {
    final response =
        await http.post(Uri.parse(Api.urlPrefix + "insert_orders.php"), body: {
      "user": id,
      "movie": movieId,
      "cinema_name": ciname,
      "seat": seat,
